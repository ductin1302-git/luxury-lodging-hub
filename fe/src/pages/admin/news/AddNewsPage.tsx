...
import { createNewsArticle, newsCategories } from "@/services/newsStore";
...
const AddNewsPage = () => {
  ...
  const handleSave = () => {
    ...
    createNewsArticle({ ...form, image: form.images[0] || form.image });
  ...
  return (
    <AdminLayout>
      <div className="flex items-center gap-4 mb-8">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white mb-1">Thêm bài viết mới</h1>
          <p className="text-gray-500 dark:text-gray-400 text-sm">Tạo nội dung mới cho website.</p>
        </div>
      </div>
