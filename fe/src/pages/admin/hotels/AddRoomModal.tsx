...
const AddRoomModal: React.FC<AddRoomModalProps> = ({ hotelId, hotelName, onClose, onSuccess }) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      await apiFetch(`/hotels/${hotelId}/rooms`, {
        method: "POST",
        body: JSON.stringify({
          ...formData,
      ...
      <div className="bg-white dark:bg-card w-full max-w-2xl rounded-2xl shadow-xl overflow-hidden flex flex-col max-h-[90vh]">
        <div className="px-6 py-4 flex items-center justify-between border-b border-gray-200 dark:border-border">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Khách sạn: <span className="text-blue-600 font-semibold">{hotelName}</span></p>
          </div>
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6 overflow-y-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-4">
              <div>
                ...
                <input 
                  ...
                  className="w-full px-4 py-2 bg-gray-50 dark:bg-muted border border-gray-200 dark:border-border rounded-xl outline-none focus:ring-2 focus:ring-blue-500/20 transition-all" 
                  placeholder="VD: Phòng Deluxe hướng hồ"
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  <label className="block text-sm font-medium mb-1.5 text-gray-700 dark:text-gray-300">D.tích (m²) *</label>
                  <input 
                    required 
                    type="number" 
                    name="size" 
              ...
              <div>
                <label className="block text-sm font-medium mb-1.5 text-gray-700 dark:text-gray-300">Số lượng khách tối đa *</label>
                <input 
                  required 
                  type="number" 
                  name="maxGuests" 
              ...
              <div>
                <label className="block text-sm font-medium mb-1.5 text-gray-700 dark:text-gray-300">Mô tả phòng *</label>
                <textarea 
                  required 
                  rows={4}
                  name="description" 
                  ...
                  placeholder="Tiện nghi, view biển, giường cỡ King..."
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Hình ảnh chi tiết ({images.filter(i => i).length})</label>
              ...
              <div className="space-y-3 max-h-[400px] overflow-y-auto pr-2 custom-scrollbar">
                    ...
                    <div className="flex items-center gap-2">
                       ...
                       <div className="flex-1">
                          <input 
                            ...
                            className="hidden"
                            id={`file-add-room-${index}`}
                          />
                          <label htmlFor={`file-add-room-${index}`} className="text-[10px] text-blue-600 font-bold cursor-pointer hover:underline mb-1 block uppercase">Thay đổi</label>
                ...
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 py-3 border-2 border-dashed border-gray-200 dark:border-border rounded-xl text-sm text-gray-500 hover:border-blue-500 hover:text-blue-500 transition-all font-medium"
                >
          ...
          <div className="flex justify-end gap-3 pt-6 border-t border-gray-100 dark:border-border">
            ...
            <button 
              ...
              className="px-8 py-2.5 bg-blue-600 hover:bg-blue-700 text-white font-bold rounded-xl transition-all shadow-lg shadow-blue-500/25"
            >
